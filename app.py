...
# --- সাইডবার ---
# লোগো ইউআরএল আপডেট করা হয়েছে (ফ্ল্যাট আইকন থেকে সরাসরি পিএনজি)
...
if app_mode == "ড্যাশবোর্ড ওভারভিউ":
    ...
    # ইমেজ ইউআরএল পরিবর্তন করা হয়েছে আরও নির্ভরযোগ্য লিঙ্কে
    st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Mirabilis_jalapa_Flower.jpg/800px-Mirabilis_jalapa_Flower.jpg", 
             caption="Mirabilis jalapa - Flower Pigmentation Study", width=500)
